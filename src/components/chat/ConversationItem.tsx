        ...
        >
            ...
            <div className="relative shrink-0">
                <img
                    src={
                        conversation.avatar
                            ? `http://localhost:8000/storage/${conversation.avatar}`
                            : "/images/profile.jpg"
                    }
            ...
            <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 mt-0.5">
                    ...
                    {conversation.unreadCount > 0 && (
                        <div className="bg-blue-600 text-white text-[10px] font-medium px-1.5 min-w-4.5 h-4.5 flex items-center justify-center rounded-full">
